        ...
        <form action="/insertmanual" method="POST">
            ...
            <div class="container">
                <div class="mb-3">
                    ...
                    <select class="form-control select2" size="width="100%;" name="proyek_id" id="proyek_id" required>
                 ...
                 <div class="mb-3">
                    ...
                    <input type="text" name="satker" class="form-control" id="satker"
                        aria-describedby="emailHelp"  placeholder="Isikan Kesatuan /Satker Manual">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Nama</label>
                    <input type="text" name="nama" class="form-control" id="nama"
                        aria-describedby="emailHelp" required placeholder="Isikan Nama Manual">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Jabatan</label>
                    <input type="text" name="jabatan" class="form-control" id="jabatan"
                        aria-describedby="emailHelp"  placeholder="Isikan Jabatan Manual">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Pangkat</label>
                    <input type="text" name="pangkat" class="form-control" id="pangkat"
                        aria-describedby="emailHelp"  placeholder="Isikan Pangkat Manual">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Quality Control</label>
                    <select class="form-control select2" name="quality_id" id="quality_id" required>
            ...
            <div class="container mt-4">
                <div class="row justify-content-center text-center g-3">
                    ...
                    <div class="col-md-6 col-12">
                        <a href="{{ route('frdakur') }}" class="btn btn-secondary w-100 py-2">Kembali</a>
                    </div>
                </div>
            </div>
</body>
